# falco-homelab-rules Specification

## Purpose
Keep Falco useful in this homelab by shipping a curated, repo-managed rule bundle through the supported post-install security path.
