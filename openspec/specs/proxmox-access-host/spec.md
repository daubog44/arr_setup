# proxmox-access-host Specification

## Purpose
Define the stable operator contract for separating the Proxmox node name from the workstation-reachable API and SSH access host used during bootstrap.
## Requirements
