...
Define the official browser-facing UI catalog for the homelab stack, including publication, auth protection, Homepage visibility, and endpoint verification.
