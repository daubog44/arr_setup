...
- [ ] 1.1 Switch the Falco platform application from `modern_ebpf` to `ebpf` and document the LXC-specific reason in the template
...
- [ ] 2.2 Publish the GitOps changes and verify the Falco pods become healthy on the cluster
