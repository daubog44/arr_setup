...
- [x] 2.2 Re-run the live bootstrap path until `wait-for-stack` clears the `haac-stack` GPU blocker or record the exact remaining blocker with the furthest verified phase
