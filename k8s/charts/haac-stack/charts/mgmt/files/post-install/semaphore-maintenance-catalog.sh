...
MAINTENANCE_K3S_PLAYBOOK_PATH="ansible/maintenance-k3s-playbook.yml"
...
MAINTENANCE_PROXMOX_PLAYBOOK_PATH="ansible/maintenance-proxmox-playbook.yml"
...
MAINTENANCE_RESTORE_PLAYBOOK_PATH="ansible/restore-k3s-playbook.yml"
...
MAINTENANCE_SMOKE_PLAYBOOK_PATH="ansible/smoke-ping-playbook.yml"
